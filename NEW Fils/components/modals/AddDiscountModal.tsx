...
export default function AddDiscountModal({ isOpen, onClose, customer }: AddDiscountModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Logic to add discount would go here
        ...
        >
          ...
          <div className="p-4 border-b border-gray-100 flex justify-between items-center bg-white">
            ...
            <div className="flex items-center gap-2 text-[#2ecc71]">
              <h2 className="text-xl font-bold">اضافة خصم ({customer?.name || 'عميل افتراضي'})</h2>
            </div>
          </div>
