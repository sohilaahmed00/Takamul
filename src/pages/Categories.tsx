      ...
      <div className="bg-[var(--bg-card)] rounded-b-2xl shadow-sm border border-[var(--border)] p-4 min-h-[400px]">
        <div className="space-y-4">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
            ...
            <div className="relative w-full md:w-80">
              <input
                ...
                className={cn(
                  "w-full border border-[var(--border)] bg-[var(--input-bg)] rounded-xl px-4 py-2 text-sm outline-none focus:border-[var(--primary)] transition-all",
                      ...
                      <td>
                        <div className="flex items-center justify-center gap-2">
                          <button 
                            ...
                            className="p-1.5 text-[var(--primary)] hover:bg-[var(--primary)]/10 dark:hover:bg-[var(--primary)]/20 rounded-lg transition-colors border border-[var(--primary)]/20 dark:border-[var(--primary)]/30"
                            title={t('edit')}
                          >
                            <Edit size={16} />
                          </button>
          ...
          <div className="md:hidden space-y-4">
            {paginatedCategories?.length === 0 ? (
              <div className="p-8 text-center text-[var(--text-muted)] italic bg-[var(--bg-main)] rounded-xl border border-dashed border-[var(--border)]">
                {t('no_data_in_table')}
              </div>
            ) : (
              paginatedCategories?.map((category) => (
