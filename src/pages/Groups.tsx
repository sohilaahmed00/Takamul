...
export default function UserGroups() {
    ...
    const handleDelete = async (id: number) => {
        try {
            ...
            setToastMessage(t('delete_group_success') || 'تم حذف المجموعة');
            setToastType('success');
            setShowToast(true);

        } catch (e) {

            setToastMessage(t('delete_group_error') || 'فشل حذف المجموعة');
            setToastType('error');
            setShowToast(true);
    ...
    const handleDuplicate = async (id: number) => {
        try {
            ...
            setToastMessage(t('duplicate_group_success') || 'تم تكرار المجموعة');
            setToastType('success');
            setShowToast(true);

        } catch (e) {

            setToastMessage(t('duplicate_group_error') || 'فشل التكرار');
            setToastType('error');
            setShowToast(true);
            ...
            <div className="takamol-page-header">
                ...
                <div className={direction === 'rtl' ? 'text-right' : 'text-left'}>
                    ...
                    <h1 className="takamol-page-title flex items-center gap-2">
                        <Users size={24} />
                        {t('user_groups') || 'مجموعات المستخدمين'}
                    </h1>
