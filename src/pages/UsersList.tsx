            ...
            <div className="bg-[var(--bg-card)] rounded-b-2xl shadow-sm border border-[var(--border)] p-4 min-h-[400px]">
                <div className="space-y-4">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        ...
                        <div className="relative w-full md:w-80 order-2 md:order-1">
                            <input
                                ...
                                className={cn(
                                    "w-full border border-[var(--border)] bg-[var(--input-bg)] rounded-xl px-4 py-2 text-sm outline-none focus:border-[var(--primary)] transition-all text-[var(--text-main)]",
                        ...
                        <div className="flex items-center gap-2 order-1 md:order-2">
                            ...
                            <select
                                className="border border-[var(--border)] bg-[var(--input-bg)] text-[var(--text-main)] rounded-lg px-2 py-1.5 outline-none focus:border-[var(--primary)] text-sm font-bold"
                            >
                                        ...
                                        <tr key={`desktop-${user.id}`}>
                                            <td>
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className={direction === 'rtl' ? 'text-right' : 'text-left'}>
                                                        <p className="font-bold text-[var(--text-main)] text-sm">{user.firstName} {user.lastName}</p>
                    ...
                    <div className="md:hidden space-y-4 mt-6">
                        ...
                        {filteredUsers.length === 0 && (
                            <div className="p-12 text-center text-[var(--text-muted)] bg-[var(--bg-main)] rounded-xl border border-dashed border-[var(--border)]">
                                {t('no_data_in_table')}
                            </div>
                        )}
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-6 mt-4 border-t border-[var(--border)]">
                        ...
                        <div className="flex items-center gap-2">
                            <button className="px-3 py-1.5 rounded-lg border border-[var(--border)] bg-[var(--bg-card)] hover:bg-[var(--bg-main)] text-sm font-medium transition-colors text-[var(--text-main)]">
                                {t('previous')}
                            </button>
                            <div className="flex items-center gap-1">
                                <button className="w-8 h-8 flex items-center justify-center rounded-lg bg-[var(--primary)] text-white font-bold text-sm shadow-sm">
                                    1
                                </button>
                            </div>
                            <button className="px-3 py-1.5 rounded-lg border border-[var(--border)] bg-[var(--bg-card)] hover:bg-[var(--bg-main)] text-sm font-medium transition-colors text-[var(--text-main)]">
