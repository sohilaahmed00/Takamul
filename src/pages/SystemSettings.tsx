    ...
    <section id={id} className="bg-[var(--bg-card)] rounded-xl shadow-sm border border-[var(--border)] overflow-hidden mb-8 scroll-mt-24">
      ...
      <div className="p-6">
        ...
        <div className="mt-8 pt-6 border-t border-[var(--border)] flex justify-start">
          <button 
            onClick={onSave}
            className="bg-emerald-600 text-white px-6 py-2 rounded-lg flex items-center gap-2 hover:bg-emerald-700 transition-colors shadow-sm font-bold"
          >
            <Save size={18} />
            {t('save_settings')}
          </button>
            ...
            <nav className="p-2 space-y-1">
              {sections.map((section) => (
                <button
                  ...
                  className={cn(
                    "w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all text-sm text-right",
