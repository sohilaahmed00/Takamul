...
export default function SalesByCategoryReport() {
  ...
  const data = [
    { name: 'بيلثيقبلفا', total: '0.00', cost: '0.00', profit: '0.00' },
    { name: 'وجبات / wajabat', total: '364.00', cost: '0.00', profit: '316.52' },
    { name: 'مطعم / Restaurant', total: '191.00', cost: '0.00', profit: '166.09' },
    { name: 'مطعم', total: '0.00', cost: '0.00', profit: '0.00' },
    { name: 'مشروبات ساخنه', total: '0.00', cost: '0.00', profit: '0.00' },
    { name: 'مشروبات بارده', total: '0.00', cost: '0.00', profit: '0.00' },
    { name: 'مشروبات / mashrubat', total: '3.50', cost: '0.00', profit: '3.04' },
    { name: 'مشتريات', total: '0.00', cost: '0.00', profit: '0.00' },
    { name: 'مأكولات خفيفه / makulat khafifih', total: '9.00', cost: '0.00', profit: '7.83' },
    { name: 'كوفي / الديوانيه', total: '0.00', cost: '0.00', profit: '0.00' },
  ];
    ...
    <div className="p-4 space-y-6 bg-white dark:bg-gray-900 min-h-screen" dir={direction}>
      ...
      <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-2">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-bold text-emerald-800">تقرير المبيعات حسب التصنيفات</h1>
        </div>
        <div className="flex items-center gap-2">
          ...
          <table className="w-full text-sm text-right border-collapse">
            <thead>
              <tr className="bg-emerald-600 text-white">
                <th className="px-3 py-2 border border-emerald-700 font-bold">اسم</th>
                <th className="px-3 py-2 border border-emerald-700 font-bold">مجموع المبيعات</th>
                <th className="px-3 py-2 border border-emerald-700 font-bold">تكلفة</th>
                <th className="px-3 py-2 border border-emerald-700 font-bold">ربح</th>
              </tr>
            </thead>
            ...
            <tfoot className="bg-gray-50 dark:bg-gray-800/50 font-bold">
              <tr>
                <td className="px-3 py-2 border border-gray-200 dark:border-gray-700 text-gray-400">[كود الصنف] [اسم الصنف]</td>
