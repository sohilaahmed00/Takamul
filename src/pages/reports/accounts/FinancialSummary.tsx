...
import { Download, Printer, DollarSign, TrendingUp, TrendingDown, Wallet, Plus } from "lucide-react";
              ...
              {stats.map((stat, index) => (
                <div key={index} className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className={cn("text-xs font-bold px-2 py-1 rounded-full", stat.trend.startsWith("+") ? "bg-[var(--primary)]/10 text-[var(--primary)]" : "bg-red-100 text-red-700")}>{stat.trend}</span>
                  </div>
