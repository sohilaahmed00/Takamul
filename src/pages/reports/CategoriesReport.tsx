    ...
    <div className="p-4 space-y-6 bg-white dark:bg-gray-900 min-h-screen" dir={direction}>
      ...
      <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-2">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-bold text-[var(--primary)]">تقرير عن التصنيفات</h1>
          ...
          <table className="w-full text-sm text-right border-collapse">
            <thead>
              <tr className="bg-[var(--primary)] text-white">
                <th className="px-3 py-2 border border-[var(--primary)]/30 font-bold">رمز فئة</th>
                <th className="px-3 py-2 border border-[var(--primary)]/30 font-bold">اسم التصنيف</th>
                <th className="px-3 py-2 border border-[var(--primary)]/30 font-bold">شراء</th>
                <th className="px-3 py-2 border border-[var(--primary)]/30 font-bold">مباعة</th>
                <th className="px-3 py-2 border border-[var(--primary)]/30 font-bold">قيمة مشتريات الصنف</th>
                <th className="px-3 py-2 border border-[var(--primary)]/30 font-bold">قيمة الأصناف المباعة</th>
                <th className="px-3 py-2 border border-[var(--primary)]/30 font-bold">الأرباح و / أو الخسارة</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              {data.map((row, idx) => (
                <tr key={idx} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                  <td className="px-3 py-2 border border-gray-200 dark:border-gray-700 font-mono">{row.id}</td>
            ...
            <tfoot className="bg-gray-50 dark:bg-gray-800/50 font-bold">
              <tr>
                <td className="px-3 py-2 border border-gray-200 dark:border-gray-700 text-gray-400">[رمز فئة]</td>
                <td className="px-3 py-2 border border-gray-200 dark:border-gray-700 text-gray-400">[اسم التصنيف]</td>
                <td className="px-3 py-2 border border-gray-200 dark:border-gray-700">102.00</td>
                <td className="px-3 py-2 border border-gray-200 dark:border-gray-700">282.00</td>
                <td className="px-3 py-2 border border-gray-200 dark:border-gray-700">4,446.58</td>
                <td className="px-3 py-2 border border-gray-200 dark:border-gray-700">8,956.10</td>
                <td className="px-3 py-2 border border-gray-200 dark:border-gray-700">4,509.52</td>
              </tr>
            </tfoot>
          </table>
        </div>
