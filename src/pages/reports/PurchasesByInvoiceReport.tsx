...
export default function PurchasesByInvoiceReport() {
  ...
  const exportColumns = [
    ...
    { header: t("total_purchases_excl_tax", "إجمالي المشتريات بدون ضريبة"), field: "subTotal", body: (r: any) => formatNumber(r.subTotal) },
        ...
        <CardContent className="space-y-4">
          ...
          <div className="rounded-xl border border-gray-100 dark:border-slate-800 overflow-hidden">
            ...
            >
              ...
              <Column field="subTotal" header={t("total_purchases_excl_tax", "إجمالي المشتريات بدون ضريبة")} sortable body={(r) => <span className="text-sm font-medium">{formatNumber(r.subTotal)}</span>} />
