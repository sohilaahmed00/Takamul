...
import { BarChart2, CalendarDays, Filter, RotateCcw, Search, Printer, FileText, FileSpreadsheet } from "lucide-react";
      ...
      <Card>
        ...
        <CardContent className="space-y-5">
          ...
          <div className="rounded-xl border border-gray-100 dark:border-slate-800 overflow-hidden">
            <DataTable value={reportData || []} loading={isLoading || isFetching} responsiveLayout="stack" className="custom-green-table custom-compact-table" emptyMessage={t("no_data", "لا توجد بيانات")} paginator rows={10}>
