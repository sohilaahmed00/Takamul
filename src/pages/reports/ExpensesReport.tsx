            ...
            <tbody>
              {expenses.map((expense, index) => (
                <tr key={expense.id} className={cn(index % 2 === 0 ? 'bg-white' : 'bg-[var(--primary)]/5')}>
                  ...
                  <td className="p-3 border border-gray-200 text-sm font-bold">{expense.paid.toFixed(2)}</td>
                  <td className="p-3 border border-gray-200 text-sm">{expense.notes}</td>
                  <td className="p-3 border border-gray-200 text-sm">{expense.user}</td>
                </tr>
              ))}
              {/* Footer Row */}
              <tr className="bg-gray-50 font-bold text-gray-600">
                ...
                <td className="p-3 border border-gray-200 text-sm text-[var(--primary)]">20,000.00</td>
