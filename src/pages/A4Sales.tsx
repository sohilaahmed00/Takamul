...
// بيانات احتياطية لمنع الشاشة البيضاء
const mockSales: SaleRecord[] = [
  { id: "1", invoiceNo: "A4-506", date: "23/02/2026 02:59:57", refNo: "SALE/A4/0611", cashier: "شركة اختيار", customer: "شخص عام", saleStatus: "returned", grandTotal: -500.0, paid: -500.0, remaining: 0.0, paymentStatus: "paid", paymentType: "mada" },
  { id: "2", invoiceNo: "A4-505", date: "23/02/2026 02:58:48", refNo: "SALE/A4/0611", cashier: "شركة اختيار", customer: "شخص عام", saleStatus: "completed", grandTotal: 500.0, paid: 500.0, remaining: 0.0, paymentStatus: "paid", paymentType: "mada" },
  { id: "3", invoiceNo: "A4-504", date: "16/02/2026 20:39:44", refNo: "SALE/A4/0610", cashier: "شركة اختيار", customer: "شخص عام", saleStatus: "completed", grandTotal: 150.0, paid: 150.0, remaining: 0.0, paymentStatus: "paid", paymentType: "mada" },
];
...
export default function A4Sales() {
  ...
  // سحب البيانات من الـ Context بأمان
  ...
  // إغلاق القوائم المنسدلة عند الضغط في أي مكان فارغ
  useEffect(() => {
  ...
  // الحالات الخاصة بالنوافذ المنبثقة (Modals) للـ 16 وظيفة
  ...
  // تحديث الصفحة عند البحث
  useEffect(() => {
    setCurrentPage(1);
  }, [searchTerm, appliedFilters, showCount]);

  // محاكاة تحميل المدفوعات عند فتح مودال المدفوعات
  useEffect(() => {
    if (showPayments) {
  ...
  return (
    <div className="space-y-4 pb-12" dir={direction}>
      ...
      <div className="text-sm text-gray-500 flex items-center gap-1 font-medium px-2">
        ...
        <span>/</span>
        <span className="text-gray-800">مبيعات A4</span>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl font-bold text-gray-800">مبيعات A4 (جميع الفروع)</h1>
        </div>
        <div className="flex items-center gap-2">
            ...
            {activeActionMenu === "header-actions" && (
              <div
                className={cn(
                  ...
                  direction === "rtl" ? "left-0" : "right-0", // فتح القائمة للداخل
                )}
              >
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6 min-w-0">
        ...
        {/* الجدول الموحد ذو الحواف المنحنية والهيدر الأخضر */}
              ...
              <tbody className="bg-white">
                {paginatedSales.map((sale) => (
                  <tr key={`desktop-${sale.id}`} className="hover:bg-gray-50 transition-colors border-b border-gray-100 cursor-pointer" onClick={() => setShowInvoiceDetails(sale)}>
                    ...
                    {/* زر الإجراءات الموسطن مع ה-16 وظيفة */}
      ...
      {/* ========================================================== */}
      {/* كل الموديلز كما هي لتشغيل عرض الفاتورة والمدفوعات وغيرها */}
      {/* ========================================================== */}
      <AnimatePresence>
