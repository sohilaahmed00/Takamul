...
export default function AddUser() {
  ...
  const inputClasses =
    "w-full p-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all text-sm";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              >
                ...
                <option value="takeaway">{t("takeaway") || "سفري"}</option>
                <option value="dinein">{t("dine_in") || "محلي"}</option>
              </select>
            </div>
          </div>
