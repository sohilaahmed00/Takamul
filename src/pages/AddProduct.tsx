...
export default function AddProduct() {
  ...
  useEffect(() => {
    ...
    switch (type) {
      ...
      case "RawMatrial": {
        // FIX: was `if (!productDataPrepared)` — should be `productDataRawMaterial`
  ...
  const buildFormData = useCallback(
    (data: FormValues): FormData => {
      ...
      // Scalar fields – skip fields handled separately
      ...
      if (isEditMode) {
        ...
        switch (productType) {
          case "Branched":
            ...
            break;
          // FIX: was missing `break` — fell through into "Prepared"
          case "Direct":
          ...
          case "Prepared":
            ...
            break;
          default:
            console.warn("نوع منتج غير معروف للتعديل:", productType);
        }
      } else {
        switch (productType) {
          case "RawMatrial":
