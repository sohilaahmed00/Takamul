    ...
    <div className="min-h-screen flex transition-colors duration-300 font-cairo" dir={direction}>
      ...
      >
        ...
        <div className="p-3 space-y-1">
          ...
          {hasAnyPermission([...Object.values(Permissions?.salesOrders), ...Object.values(Permissions?.salesReturns)]) && <SidebarItem icon={ShoppingCart} label={t("sales")} hasSubmenu isSidebarOpen={showSidebarContent} isOpen={openSubmenu === "sales"} onClick={() => toggleSubmenu("sales")} />}
          <AnimatePresence>
