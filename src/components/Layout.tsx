    ...
    <div className="min-h-screen flex transition-colors duration-300" dir={direction}>
      ...
      <motion.aside
        ...
        className={cn(
          ...
          direction === 'rtl' ? 'right-0 border-l border-[var(--border)]' : 'left-0 border-r border-[var(--border)]'
        )}
        initial={false}
        animate={{
        ...
        <div className="p-4 flex items-center justify-between h-16 border-b border-[var(--border)]">
          <div
            className={cn(
              ...
              !showSidebarContent && 'justify-center w-full'
            )}
          >
            {showSidebarContent ? (
