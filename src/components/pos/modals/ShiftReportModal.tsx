      ...
      <DialogContent showCloseButton={false} className="max-w-[500px] p-0 overflow-hidden bg-[#f8fafc] dark:bg-slate-900 border-none shadow-2xl rounded-3xl">
        ...
        <div className="flex items-center justify-between p-4 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 shadow-sm relative z-20">
          <Button 
            ...
            className="bg-[#000052] hover:bg-[#000052]/90 text-white font-bold h-9 px-4 rounded-xl shadow-md flex items-center gap-2 transition-all active:scale-95 text-xs"
          >
            <Printer size={14} />
            طباعة
          </Button>
          ...
          <div className="flex items-center gap-3">
            <Button 
              ...
              className="bg-[#22c55e] hover:bg-[#16a34a] text-white font-bold h-9 px-4 rounded-xl shadow-md flex items-center gap-2 transition-all active:scale-95 text-xs"
            >
              <Lock size={14} />
              غلق الوردية
            </Button>
            ...
            <button 
              onClick={onClose}
              className="w-9 h-9 rounded-xl flex items-center justify-center bg-slate-100 hover:bg-red-50 hover:text-red-500 transition-all text-slate-500"
            >
              <X size={18} />
            </button>
          </div>
