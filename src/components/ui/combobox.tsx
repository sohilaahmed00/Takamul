      ...
      <InputGroupAddon align="inline-end">
        {showTrigger && (
          <InputGroupButton
            ...
            className="group-has-data-[slot=combobox-clear]/input-group:hidden data-pressed:bg-transparent hover:bg-transparent dark:hover:bg-transparent"
            disabled={disabled}
          >
            <ComboboxTrigger />
          </InputGroupButton>
...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        "flex min-h-8 flex-wrap items-center gap-1 rounded-lg border border-input bg-[#f9fafb] bg-clip-padding px-2.5 py-1 text-sm transition-colors focus-within:border-xx focus-within:xx-3 focus-within:xx-xx/50 has-aria-invalid:border-destructive has-aria-invalid:xx-3 has-aria-invalid:xx-destructive/20 has-data-[slot=combobox-chip]:px-1 dark:bg-input/30 dark:has-aria-invalid:border-destructive/50 dark:has-aria-invalid:xx-destructive/40",
        className
      )}
      {...props}
    />
