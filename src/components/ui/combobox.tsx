  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        ...
        "[.red_&]:bg-input/30 [.blue_&]:bg-input/30 [.yellow_&]:bg-input/30 [.high-contrast_&]:bg-input/30",
...
function ComboboxChip({
  ...
  return (
    <ComboboxPrimitive.Chip data-slot="combobox-chip" className={cn("flex h-[calc(--spacing(5.25))] w-fit items-center justify-center gap-1 rounded-sm bg-muted px-1.5 text-xs font-medium whitespace-nowrap text-foreground has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50 has-data-[slot=combobox-chip-remove]:pe-0", className)} {...props}>
      {children}
      {showRemove && (
