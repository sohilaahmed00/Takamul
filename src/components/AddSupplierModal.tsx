...
export default function AddSupplierModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.supplierName.trim()) {
      return showToast(
        "error",
        t("please_enter_supplier_name") || "اسم المورد مطلوب"
      );
    }
    ...
    try {
      ...
      if (result?.ok || result === true) {
        showToast(
          "success",
          supplier
            ? t("supplier_updated_successfully") || "تم تحديث بيانات المورد بنجاح"
            : t("supplier_added_successfully") || "تم إضافة المورد بنجاح"
        );
  ...
  return (
    <>
      <ResponsiveModal
        ...
        title={
          supplier
            ? t("edit_supplier") || "تعديل مورد"
            : t("add_supplier") || "إضافة مورد"
        }
        maxWidth="max-w-3xl"
      >
