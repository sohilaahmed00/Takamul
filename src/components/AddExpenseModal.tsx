        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <input 
              ...
              value={formData.date}
              readOnly
              className="takamol-input bg-[var(--bg-main)] cursor-not-allowed"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <input 
                ...
                className="hidden"
              />
              <div className="flex-1 takamol-input !py-2 !bg-[var(--bg-main)] truncate text-[10px]">
        ...
        <div className="space-y-2">
          ...
          <div className="border border-[var(--border)] rounded-2xl overflow-hidden focus-within:ring-2 focus-within:ring-[var(--primary)]/20 transition-all">
            <div className="bg-[var(--bg-main)] p-2 border-b border-[var(--border)] flex flex-wrap gap-2 text-xs">
              <button type="button" className="p-1 hover:bg-white dark:hover:bg-gray-800 rounded border border-transparent hover:border-[var(--border)] font-bold">B</button>
              <button type="button" className="p-1 hover:bg-white dark:hover:bg-gray-800 rounded border border-transparent hover:border-[var(--border)] italic">I</button>
              <button type="button" className="p-1 hover:bg-white dark:hover:bg-gray-800 rounded border border-transparent hover:border-[var(--border)] underline">U</button>
            </div>
            <textarea 
              rows={3}
              value={formData.description}
              onChange={(e) => setFormData({ ...formData, description: e.target.value })}
              className="w-full p-3 bg-white dark:bg-gray-900 text-[var(--text-main)] outline-none resize-none text-sm min-h-[100px]"
            />
          </div>
        </div>
