      ...
      footer={
        <div className="flex justify-end gap-3 w-full">
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors text-sm font-bold shadow-sm"
          >
            <Save size={18} />
            {t('save')}
          </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 bg-white dark:bg-gray-900 outline-none focus:border-emerald-500 text-sm"
            />
          </div>
          <div className="space-y-1">
